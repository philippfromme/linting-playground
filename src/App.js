...
export default function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      await modeler.importXML(diagramSimple);
...
function LintingReport(props) {
  ...
  return <div className="linting-report">
    ...
    <div className="linting-report__text">
      Error : <span className="linting-report__link" onClick={ onClick }>{ label || id }</span> - <span className="linting-report__message">{message}</span>
    </div>
  </div>;
}
